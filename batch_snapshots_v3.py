...
players_raw = [
    ...
    (41083, "Aymes",      "Deel",    12,  75, 34.373, 25.369,  6.107, 23.340, 68.294, 1053, "2026-09-16"),
    ...
    (41194, "Marshall",   "Longworth",12,   2, 31.959, 27.294, 24.685, 42.138, 61.085,   29, "2026-07-21"),  # DUPLICATE - wrong profile
    ...
    # Correct Marshall Longworth (was using wrong profile 41194)
    (20752, "Marshall",   "Longworth",12, 700, 37.300, 23.389, 21.184, 29.242, 91.372,10442, "2026-09-24"),
]
